...
char* 
cut_symb(char str1[255], int numsymb)
// cuts the char #numsymb from the string str1
{
...
char* 
clearchar(char* str1, char to_del[255])
// removes chars in to_del from str1
{
    int pos;
    char* p;
...
int 
isPalindrome(char str4[255])
// checks if str4 is a palindrom
{
